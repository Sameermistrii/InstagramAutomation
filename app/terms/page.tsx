...
export const metadata: Metadata = {
  title: "Terms of Service - UniSin",
  description:
    "Terms for using UniSin's Instagram comment-to-DM campaign software.",
};
...
export default function TermsPage() {
  return (
    <LegalShell
      ...
      description="These terms define acceptable use for UniSin's hosted Instagram comment-to-DM campaign service."
      updatedAt="May 24, 2026"
    >
      <section>
        <h2 className="text-xl font-bold text-white">Authorized Use</h2>
        <p className="mt-3">
          You may use UniSin only with Instagram professional accounts you
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          UniSin may rate-limit, pause, or disable campaigns that create
      ...
      <section>
        ...
        <p className="mt-3">
          UniSin depends on third-party platforms including Meta, email,
